...
namespace Centrex.My
{
    ...
    internal sealed partial class MySettings : System.Configuration.ApplicationSettingsBase
    {
        ...
        */
        ...
        [System.Configuration.DefaultSettingValue("Data Source=127.0.0.1;Initial Catalog=dbCentrex;Persist Security Info=True;User I" + "D=sa;Password=Ladeda78")]

        public string dbCentrexConnectionString
        {
            get
            {
                return Conversions.ToString(this["dbCentrexConnectionString"]);
            }
        }
    }
}
