...
[Table("tmpregistros_stock")]
public partial class TmpRegistroStockEntity
{
    [Key]
    [Column("id_registrotmp")]
    public int IdRegistrotmp { get; set; }
    ...
    [ForeignKey("IdItem")]
    [InverseProperty("TmpRegistroStockEntity")]
