...
namespace Centrex
{
    ...
    public partial class add_cliente : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            txt_notas.TextChanged += new EventHandler(txt_notas_TextChanged);
            lbl_notas = new Label();
            ...
            txt_nombreFantasia = new TextBox();
            lbl_nombreFantasia = new Label();
            cmb_tipoDocumento = new ComboBox();
            cmb_tipoDocumento.SelectionChangeCommitted += new EventHandler(cmb_tipoDocumento_SelectionChangeCommitted);
            cmb_tipoDocumento.KeyPress += new KeyPressEventHandler(cmb_tipoDocumento_KeyPress);
            ...
            txt_taxNumber.LostFocus += new EventHandler(txt_taxNumber_LostFocus);
            ...
            cmb_paisFiscal.KeyPress += new KeyPressEventHandler(cmb_paisFiscal_KeyPress);
            lbl_paisFiscal = new Label();
            cmb_provinciaFiscal = new ComboBox();
            cmb_provinciaFiscal.KeyPress += new KeyPressEventHandler(cmb_provinciaFiscal_KeyPress);
            ...
            cmb_paisEntrega.KeyPress += new KeyPressEventHandler(cmb_paisEntrega_KeyPress);
            lbl_paisEntrega = new Label();
            cmb_provinciaEntrega = new ComboBox();
            cmb_provinciaEntrega.KeyPress += new KeyPressEventHandler(cmb_provinciaEntrega_KeyPress);
            ...
            txt_localidadFiscal.TabIndex = 11;
            // 
            // lbl_localidadFiscal
            // 
            lbl_localidadFiscal.AutoSize = true;
            lbl_localidadFiscal.Location = new Point(26, 239);
            ...
            cmd_exit.Location = new Point(432, 543);
            ...
            // cmd_ok
            // 
            cmd_ok.Location = new Point(334, 543);
            cmd_ok.Name = "cmd_ok";
            ...
            tab_general.Controls.Add(txt_nombreFantasia);
            tab_general.Controls.Add(lbl_nombreFantasia);
            ...
            // txt_nombreFantasia
            // 
            txt_nombreFantasia.Location = new Point(149, 88);
            txt_nombreFantasia.MaxLength = 45;
            txt_nombreFantasia.Name = "txt_nombreFantasia";
            txt_nombreFantasia.Size = new Size(163, 20);
            txt_nombreFantasia.TabIndex = 2;
            // 
            // lbl_nombreFantasia
            // 
            lbl_nombreFantasia.AutoSize = true;
            lbl_nombreFantasia.Location = new Point(28, 95);
            lbl_nombreFantasia.Name = "lbl_nombreFantasia";
            lbl_nombreFantasia.Size = new Size(101, 13);
            lbl_nombreFantasia.TabIndex = 61;
            lbl_nombreFantasia.Text = "Nombre de fantasía";
            // 
            // cmb_tipoDocumento
            // 
            cmb_tipoDocumento.FormattingEnabled = true;
            cmb_tipoDocumento.Location = new Point(149, 159);
            cmb_tipoDocumento.Name = "cmb_tipoDocumento";
            cmb_tipoDocumento.Size = new Size(163, 21);
            cmb_tipoDocumento.TabIndex = 3;
            // 
            // lbl_tipoDocumento
            // 
            lbl_tipoDocumento.AutoSize = true;
            lbl_tipoDocumento.Location = new Point(28, 167);
            ...
            // txt_email
            // 
            txt_email.Location = new Point(149, 304);
            ...
            lbl_email.Location = new Point(28, 311);
            ...
            // txt_contacto
            // 
            txt_contacto.Location = new Point(149, 196);
            ...
            lbl_contacto.Location = new Point(28, 203);
            ...
            // txt_telefono
            // 
            txt_telefono.Location = new Point(149, 232);
            ...
            // txt_celular
            // 
            txt_celular.Location = new Point(149, 268);
            ...
            lbl_celular.Location = new Point(28, 275);
            ...
            cmb_provinciaFiscal.TabIndex = 9;
            // 
            // tab_entrega
            // 
            ...
            cmb_provinciaEntrega.TabIndex = 14;
            // 
            ...
            txt_direccionEntrega.TabIndex = 15;
            // 
            // lbl_direccionEntrega
            // 
            lbl_direccionEntrega.AutoSize = true;
            lbl_direccionEntrega.Location = new Point(26, 171);
            lbl_direccionEntrega.Name = "lbl_direccionEntrega";
            lbl_direccionEntrega.Size = new Size(91, 13);
            lbl_direccionEntrega.TabIndex = 44;
            lbl_direccionEntrega.Text = "Dirección entrega";
            // 
            ...
            FormClosed += new FormClosedEventHandler(add_cliente_FormClosed);
            Load += new EventHandler(add_cliente_Load);
            ResumeLayout(false);
            PerformLayout();
        ...
        internal TextBox txt_nombreFantasia;
        internal Label lbl_nombreFantasia;
