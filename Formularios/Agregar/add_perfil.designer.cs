...
namespace Centrex
{
    ...
    public partial class add_perfil : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            lbl_perfil.Location = new Point(22, 28);
            lbl_perfil.Name = "lbl_perfil";
            lbl_perfil.Size = new Size(30, 13);
            lbl_perfil.TabIndex = 0;
            ...
            // txt_perfil
            // 
            txt_perfil.Location = new Point(78, 21);
            txt_perfil.Name = "txt_perfil";
            txt_perfil.Size = new Size(259, 20);
            txt_perfil.TabIndex = 0;
            // 
            // chk_activo
            // 
            ...
            chk_activo.Size = new Size(81, 17);
            chk_activo.TabIndex = 1;
            chk_activo.Text = "Perfil activo";
            ...
            Text = "Insertar perfil";
            FormClosed += new FormClosedEventHandler(add_perfil_FormClosed);
            Load += new EventHandler(add_perfil_Load);
            ResumeLayout(false);
            PerformLayout();
